...
//file reader
vector<string> Util::importer(std::string cat){
    vector<string> DB;
...
string Util::reporting(std::string id, int qty, std::string user){
    string line;
...
vector<string> Util::split(std::string s, std::string delim){
    vector<string> vec;
